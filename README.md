...
# ВАЖНО для использования через расширение:
 ...
 + 1. У весх пользователей должна быть роль чтения справочника "ГруппыДоступа" и "ПрофилиГруппДоступа", иначе будет ошибка при
    проверке вхождения в профиль. (если в твоей конфигурации есть профиль который не содержит ни одной роли рашрешающей читать 
...
![image](https://github.com/KistanovSerhii/ElemetsOfFormDynamicP/assets/28355711/e32c5837-bcc8-44ee-918e-6b656ab49b44)
 ...
 + 2. При использовании через расширение обязательно снимите флаг "Безопасный режим, имя профиля безопасности"
